            ...
            <div class="col-12">
                <div class="card appointment-detail">
                    ...
                    <div class="card-body">
                        ...
                        @endif
                        <div class="mb-3">
                            <label for="domainInput" class="form-label">Domain <span class="text-danger">*</span></label>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="email" placeholder="a.allahverdi@icoa.it"
                                required>
                        ...
                        <div class="mb-3 form-check">
                            ...
                            <label class="form-check-label" for="defaultCheck">Use as default authenticated domain</label>
                        </div>

                        <div class="mb-3 form-check">
                            <input type="checkbox" class="form-check-input" name="automatic_security">
                            <label class="form-check-label" for="automaticSecurityCheck">Allow automatic management of SPF
                                records and DKIM keys</label>
                        </div>

                        <div class="mb-3">
                            <label for="customDkimSelectorInput" class="form-label">Custom DKIM Selector</label>
                            <input type="text" class="form-control" name="custom_dkim_selector" placeholder="XYZ">
